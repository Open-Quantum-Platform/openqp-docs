...
| `sa_casscf(active_electrons=None, active_orbitals=None, frozen_core=None, nstate=2, weights=None, target_roots=None, runtype=None, basis=None, reference="rhf", **keywords)` | `OpenQP` | Selects state-averaged CASSCF. |
