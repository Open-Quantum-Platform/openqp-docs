...
## Stable release: Studio 0.2.5

[Read release notes and compare versions](whats-new.md).

Studio **0.2.5** is released independently of OpenQP. The bundled engine is an
...
| --- | --- | --- |
| macOS, Apple Silicon | [With engine (.dmg)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-macos-apple-silicon-with-engine.dmg) | [Standard (.dmg)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-macos-apple-silicon.dmg) |
| macOS, Intel | [With engine (.dmg)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-macos-intel-with-engine.dmg) | [Standard (.dmg)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-macos-intel.dmg) |
| Windows, x64 | [With engine (.exe)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-windows-x64-with-engine-setup.exe) | [Standard (.exe)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-windows-x64-setup.exe) |
| Linux, x86_64 (Ubuntu 24.04+/Debian 13+) | [With engine (.deb)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-linux-x86_64-with-engine.deb) | [Standard (.deb)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-linux-x86_64.deb) |
| Linux, x86_64 (AppImage) | Use the standard package with a local engine | [Standard (.AppImage)](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/OQP-Studio-0.2.5-linux-x86_64.AppImage) |

[Download SHA256SUMS](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/download/v0.2.5/SHA256SUMS)
and follow the [verification instructions](packages.md#verify-a-download).
See [installation instructions](installation.md) and
[all release assets](https://github.com/Open-Quantum-Platform/oqp-studio-releases/releases/tag/v0.2.5)
...
**Upgrading from 0.2.3:** manually download and install 0.2.5 once. The old updater
